...
/**
 * An interactive contact address book
 * CS 401 Dr. Lynne GREWE
 * Student: Malik Eddy
 *
...
public class AddressBook extends JFrame implements ActionListener
{
    ...
    private final int
            panelWidth = 750, panelHeight = 500,                 // The drawing panel dimensions
    ...
    public static void main(String[] args)
    {
        ...
        contacts.setTitle("My address book: 999 ");
    ...
    private void setUpAddressBook()
    {
        ...
        addContact("John Doe", "12 Cottrell Street, Stirling", "07999232321", "john@cs.isp.com");
        addContact("Paul Doe", "23 Beatle Street, London", "0033998877", "paul@paul.net");
        addContact("George Dog", "34 Beatle Street, New York", "01222 78160", "georgie@stirling.com");
        addContact("Simon Stain", "45 Pathfoot Lane, Bridge of Allan", "0999 8888", "simon@simon.net");
        addContact("Leslie Sharp", "Box 3, Glasgow", "", "");
    ...
    private void setUpGUI()
    {
        ...
        window.setBackground( naviColor );
        ...
        namePanel.add(new JLabel("ADD/FIND NAME:"));
        namePanel.add(nameField);
        window.add(namePanel);

        JPanel addressPanel = new JPanel();
        addressPanel.add(new JLabel("ADD New address:"));
        addressPanel.add(addressField);
        window.add(addressPanel);

        JPanel mobilePanel = new JPanel();
        mobilePanel.add(new JLabel("ADD New mobile:"));
        mobilePanel.add(mobileField);
        window.add(mobilePanel);

        JPanel emailPanel = new JPanel();
        emailPanel.add(new JLabel("ADD New email:"));
        emailPanel.add(emailField);
        window.add(emailPanel);
    } // End of setUpGUI

    /**
     *  Display non-background color areas, heading and currently selected database contact.
     *
